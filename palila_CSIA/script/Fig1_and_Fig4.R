...
# # what would the region of practical equivalence (ROPE) be for trophic positio changes
# total %>% 
#   group_by(year) %>% 
...
# plot the corrected 
ggplot(total)+
  geom_violin(aes(x=year, y= tp, group = year),fill = "#2b8cbe",outlier.shape = NA, width = 5)+
